...
## Structure
Within the `liquidity_manager` directory, you'll discover multiple generated files:
...
2. Execute any of the provided action scripts using the command `python liquidity_manager/{action_file}.py`, for example, `python liquidity_manager/{train_action}.py`.
